...
Informationen zur Fehlerbehebung finden Sie unter https://kb.netapp.com/mgmt/SnapCenter/SnapCenter_MFA_login_error_The_SAML_message_response_1_doesnt_match_the_expected_response_2["Bei der SnapCenter-Anmeldung auf mehreren Registerkarten wird ein MFA-Fehler angezeigt"]
