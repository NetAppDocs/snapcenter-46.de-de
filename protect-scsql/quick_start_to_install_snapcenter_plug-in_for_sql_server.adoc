...
Für die Mindestanforderungen des ONTAP und Applikations-Plug-ins siehe https://imt.netapp.com/matrix/imt.jsp?components=103047;&solution=1257&isHWU&src=IMT["Interoperabilitäts-Matrix-Tool"^]
...
Betriebssystem (64 Bit)
 a| 
Siehe https://imt.netapp.com/matrix/imt.jsp?components=103047;&solution=1257&isHWU&src=IMT["Interoperabilitäts-Matrix-Tool"^]
