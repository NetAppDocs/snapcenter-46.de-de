...
IMPORTANT: Wenn Sie beispielsweise SnapCenter Version 4.3.x verwenden und auf 4.6.x aktualisieren möchten, sollten Sie zuerst auf 4.5.x aktualisieren und dann ein Rolling Upgrade auf 4.6.x. durchführen
