...
|===
Der https://imt.netapp.com/matrix/imt.jsp?components=103047;&solution=1257&isHWU&src=IMT["NetApp Interoperabilitäts-Matrix-Tool"] Enthält die neuesten Informationen zu den gewünschten Versionen.
